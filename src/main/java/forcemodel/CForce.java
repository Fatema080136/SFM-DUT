...
public class CForce
{
    ...
    private static double m_repulsefactortoped = 0.38*m_pixelpermeter;//0.1*m_pixelpermeter;
    private static double m_sigma = 0.065*m_pixelpermeter;//0.25*m_pixelpermeter;
    ...
    /**Vector.sub( p_desiredvelocity, p_current)
    ...
    static Vector2d fov( final CPedestrian p_self, final CPedestrian p_other )
    {
        ...
        //System.out.println(l_dir.dot(l_repulsePed)+" "+l_repulsePed.length()*Math.cos(100));
