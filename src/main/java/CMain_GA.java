...
public class CMain_GA
{
    ...
    protected static ArrayList<CSampleOutput> runSimulation(double p_pedtopedrf, double p_pedtopedsigma,int p_senarioid )
    {
        CForce.update(p_pedtopedrf, p_pedtopedsigma);
        List<CInputFormat> l_roadusers = CCsvFileReader.readDataFromCSV(System.getProperty("user.dir").concat("/start_end_DUT_extended_goal.csv"), p_senarioid);
