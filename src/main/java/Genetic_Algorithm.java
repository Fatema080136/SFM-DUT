...
public class Genetic_Algorithm
{
    ...
    public static void main(String[] args)
    {
        ...
        while(true) {
            ...
            System.out.println(population.get(population.size()-1).getScore()+" eclipse "+population.get(population.size()-1).chromo);
    ...
    private static class chromosome implements Comparable<chromosome>
    {
        ...
        private double getRandomGene(int gene)
        {
            ...
            if( gene == 0 )
            {
                return 0.1 +Precision.round(ran.nextDouble(),2)+ran.nextInt(15);//15
            }
        ...
        public double getFitnessScore( ) throws SQLException
        {
            ...
            //ArrayList<Integer> numbers = new ArrayList<>(Arrays.asList(1,2,3,5,6,8,9,10,11,12,13,14,16,20,23,24,25,26,27,28,29));
