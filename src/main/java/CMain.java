...
public class CMain extends JFrame
{
    ...
    public static void main( String []args ) throws InterruptedException
    {
        ...
        //to write simulation output
        final String l_name = System.getProperty("user.dir").concat("/DUT_dataset" +
                "circular.csv");
        ...
        for(int s = 1; s <=30; s++)
        {
            ...
            List<CInputFormat> l_roadusers = CCsvFileReader.readDataFromCSV(System.getProperty("user.dir").concat("/start_end_DUT_extended_goal.csv"), s);
            ...
            final float[] l_timestep = {l_start/2f};
                ...
                //m_output.forEach(k-> System.out.println(k.m_selfX+" "+k.m_selfY));
